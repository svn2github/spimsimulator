...
/* $Header: /Software/SPIM/src/op.h 6     2/23/04 4:42a Larus $
*/
...
#define B2_TYPE_INST		8
#define I2a_TYPE_INST		9

#define R1s_TYPE_INST		10
#define R1d_TYPE_INST		11
#define R2td_TYPE_INST		12
#define R2st_TYPE_INST		13
#define R2ds_TYPE_INST		14
#define R2sh_TYPE_INST		15
#define R3_TYPE_INST		16
#define R3sh_TYPE_INST		17

#define FP_I2a_TYPE_INST	20
#define FP_R2ds_TYPE_INST	21
#define FP_CMP_TYPE_INST	22
#define FP_R3_TYPE_INST		23
#define FP_R4_TYPE_INST		24
#define FP_MOV_TYPE_INST	25

#define J_TYPE_INST			30
#define CP_TYPE_INST		31
#define NOARG_TYPE_INST		32
...
OP ("mfhc1",   	Y_MFHC1_OP,	  	CP_TYPE_INST,			0x44600000)	/* MIPS32 Rev 2 */
OP ("mfhc2",   	Y_MFHC2_OP,	  	CP_TYPE_INST,			0x48600000)	/* MIPS32 Rev 2 */
...
OP ("mov.ps",  	Y_MOV_PS_OP,  	FP_MOV_TYPE_INST,		0x46c00006)	/* MIPS32 Rev 2 */
OP ("mov.s",   	Y_MOV_S_OP,	  	FP_MOV_TYPE_INST,		0x46000006)
OP ("move",	   	Y_MOVE_POP,	  	PSEUDO_OP,				-1)
OP ("movf.ps", 	Y_MOVF_PS_OP,  	FP_MOV_TYPE_INST,		0x46c00011)	/* MIPS32 Rev 2 */
OP ("movn.ps", 	Y_MOVN_PS_OP,  	FP_MOV_TYPE_INST,		0x46c00013)	/* MIPS32 Rev 2 */
OP ("movt.ps", 	Y_MOVT_PS_OP,  	FP_MOV_TYPE_INST,		0x46c10011)	/* MIPS32 Rev 2 */
OP ("movz.ps", 	Y_MOVZ_PS_OP,  	FP_MOV_TYPE_INST,		0x46c00012)	/* MIPS32 Rev 2 */
...
OP ("mthc1",   	Y_MTHC1_OP,	  	CP_TYPE_INST,			0x44e00000) /* MIPS32 Rev 2 */
OP ("mthc2",   	Y_MTHC2_OP,	  	CP_TYPE_INST,			0x48e00000) /* MIPS32 Rev 2 */
