...
/* $Header: /Software/SPIM/src/op.h 20    3/01/04 10:23p Larus $
*/
...
OP("mfc1.s",	Y_MFC1_OP,	R2ts_TYPE_INST,		0x44000000)
...
OP("movf",	Y_MOVF_OP,	FP_MOV_TYPE_INST,	0x00000001)	/* MIPS32 */
OP("movf.d",	Y_MOVF_D_OP,	FP_MOV_TYPE_INST,	0x46200011)	/* MIPS32 */
OP("movf.ps",	Y_MOVF_PS_OP,	FP_MOV_TYPE_INST,	0x46c00011)	/* MIPS32 Rev 2 */
OP("movf.s",	Y_MOVF_S_OP,	FP_MOV_TYPE_INST,	0x46000011)	/* MIPS32 */
